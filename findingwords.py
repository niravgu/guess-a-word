def check(para,s) :
    if para.find(s) == -1:
        ...
        print(s,"is present in the paragraph")


para = """nemo is a young clownfish who lives with his father Marlin in an anemone in the Great Barrier Reef.
...
s = input("take a guess, a word in the paragraph:")
check(para,s)
